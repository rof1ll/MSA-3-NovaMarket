...
Выбор CQRS CQRS + event sourcing с денормализованной read-моделью является оптимальным компромиссом между сложностью, производительностью и масштабируемостью.